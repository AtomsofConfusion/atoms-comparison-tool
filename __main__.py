...
def orginal_code(input_path, output_directory):
    #!/usr/bin/env python
    # coding: utf-8
    ...
    codeQL_directory = input_path+codeQL_directory
    print(codeQL_directory)
    clojure_directory = "/clojure_data/atomsClojure.csv"
    clojure_directory = input_path+clojure_directory
    coccinelle_directory = "/coccinelle_data"
    coccinelle_directory = input_path+coccinelle_directory
    dataframes = {}
    ...
    if (output_directory!="./output") and (not os.path.exists(output_directory)):
...
def main():
    ...
    orginal_code(input_path, output_path) # run the orginal comparsion tool W/O the CLI
